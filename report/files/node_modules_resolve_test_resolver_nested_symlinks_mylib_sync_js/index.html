...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/resolve/test/resolver/nested_symlinks/mylib/sync.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/resolve/test/resolver/nested_symlinks/mylib/sync.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">var a = require.resolve(&#039;buffer/&#039;).replace(process.cwd(), &#039;$CWD&#039;);
