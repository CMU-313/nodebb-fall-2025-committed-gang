...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/@webassemblyjs/ast/esm/node-path.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/@webassemblyjs/ast/esm/node-path.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
