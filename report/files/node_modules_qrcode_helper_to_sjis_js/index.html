...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/qrcode/helper/to-sjis.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/qrcode/helper/to-sjis.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">const SJIS_UTF8 = [
  [0x8140, &#039;　、。，．・：；？！゛゜´｀¨＾￣＿ヽヾゝゞ〃仝々〆〇ー―‐／＼～∥｜…‥‘’“”（）〔〕［］｛｝〈〉《》「」『』【】＋－±×&#039;],
  [0x8180, &#039;÷＝≠＜＞≦≧∞∴♂♀°′″℃&#039;],
  [0x818f, &#039;￥＄￠￡％＃＆＊＠§☆★○●◎◇◆□■△▲▽▼&#039;],
  [0x81a6, &#039;※〒→←↑↓〓&#039;],
