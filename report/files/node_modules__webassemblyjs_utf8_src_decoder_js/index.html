...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/@webassemblyjs/utf8/src/decoder.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/@webassemblyjs/utf8/src/decoder.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">function con(b) {
  if ((b &amp; 0xc0) === 0x80) {
    return b &amp; 0x3f;
  } else {
