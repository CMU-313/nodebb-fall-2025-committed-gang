...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/tsconfig-paths/lib/__tests__/match-path-async.test.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/tsconfig-paths/lib/__tests__/match-path-async.test.js</h1>
  </div>
</div>
...
//# sourceMappingURL=match-path-async.test.js.map</textarea>
  </div>
</div>
