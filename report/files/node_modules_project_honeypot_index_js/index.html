...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/project-honeypot/index.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/project-honeypot/index.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">module.exports = function(accessKey) {
	var dns = require(&#039;dns&#039;),
		HoneyPot = {};
