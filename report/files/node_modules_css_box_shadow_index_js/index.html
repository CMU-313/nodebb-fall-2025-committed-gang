...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/css-box-shadow/index.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/css-box-shadow/index.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">const VALUES_REG = /,(?![^\(]*\))/
const PARTS_REG = /\s(?![^(]*\))/
