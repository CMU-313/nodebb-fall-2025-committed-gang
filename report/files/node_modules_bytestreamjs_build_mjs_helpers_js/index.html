...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/bytestreamjs/build/mjs/helpers.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/bytestreamjs/build/mjs/helpers.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">export function parseByteMap(stream, map, elements, start = null, length = null) {
    if (start === null) {
        start = 0;
    }
